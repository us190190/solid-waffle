...
async def lifespan(application: FastAPI):
    ...
    try:
        ...
        print("Content Creation Studio shutdown - cleanup complete")


app = FastAPI(
    title="Content Creation Studio",
    description="Reflection Loop: Writer -> Critic (score <8 loop max 3) -> Editor -> Human Approval (interrupt_before) + SSE stream",
    version="0.1.0",
    lifespan=lifespan,
)
